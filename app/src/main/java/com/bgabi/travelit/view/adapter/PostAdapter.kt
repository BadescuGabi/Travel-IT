...
//        Picasso.get().load(modal.postImage).placeholder(R.drawable.me).into(holder.authorIV)
//        holder.authorNameTV.setText(modal.postUser)
//        holder.timeTV.setText(modal.postDate)
//        holder.descTV.setText(modal.postDescription)
//        Picasso.get().load(modal.postIV).placeholder(R.drawable.gmail_button).into(holder.postIV)
